...
Functionaliteit: Tg023 - Egberts-Ederveen Cat.11 = 12
  ...
  Achtergrond:
    ...
    * heeft de volgende gegevens
    ...
    Gegeven de persoon 'Egberts' zonder burgerservicenummer heeft de volgende gegevens
      | naam                        | waarde   |
      | voornamen (02.10)           | Ewald    |
      | geslachtsnaam (02.40)       | Egberts  |
      | geboortedatum (03.10)       | 19721001 |
  ...
  Scenario: Lg01_128 - erkend, categorie 03 op PL kind zonder SoFi-nr/BSN, wel A-nr/BSN in categorie 09 PL vader/erkenner, indicatie gezag 12
    # Route: Transformeer gezag uitspraak GezamenlijkOuderlijkGezag (v2) naar GezagNietTeBepalen (v1) omdat een ouder van de minderjarige het burgerservicenummer mist 7e
