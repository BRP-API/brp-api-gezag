...
Functionaliteit: 1.3 - is naar buitenland geëmigreerd geweest
  ...
  Scenario: Een kind met twee ouders dat altijd in Nederland heeft gewoond er is sprake van GezamenlijkOuderlijkGezag
    Als 'gezag' wordt gevraagd van 'Lisa'
    Dan is het gezag over 'Lisa' gezamenlijk ouderlijk gezag met ouder 'Maurice' en ouder 'Ruth'
  ...
  Scenario: Van een kind dat geëmigreerd is geweest kan geen gezag worden bepaald
    ...
    * is geëmigreerd geweest
    Als 'gezag' wordt gevraagd van 'Lisa'
    Dan is het gezag over 'Lisa' niet te bepalen met de toelichting 'Gezag kan niet worden bepaald omdat minderjarige buiten Nederland heeft verbleven.'
