...
Functionaliteit: 3.1 - is er sprake van een recente gebeurtenis - ontkenning
  ...
  Regel: Als vaderschap is ontkend of de erkenning is vernietigd en er was een uitspraak gezag voor die ouder, wordt het gezag van rechtswege bepaald
    ...
    Abstract Scenario: er is uitspraak gezag voor <omschrijving gezagsuitspraak> en erkenning door ouder <ouder> is ontkend of vernietigd er is sprake van Voogdij want <reden>
      Gegeven voor 'Kees' is een gerechtelijke uitspraak over het gezag gedaan met de volgende gegevens
        | indicatie gezag minderjarige (32.10) | ingangsdatum geldigheid (85.10) |
        | <indicatie gezag>                    | morgen - 10 jaar                |
      En zijn van ouder <ouder> de volgende gegevens gewijzigd
        | naam                                               | waarde  |
        | burgerservicenummer (01.20)                        |         |
        | geslachtsnaam (02.40)                              |         |
        | geboortedatum (03.10)                              |         |
      ...
      Voorbeelden:
        | indicatie gezag | omschrijving gezagsuitspraak | ouder | reden                                                          |
        | D               | een derde                    |     1 | de ontkenning heeft geen betrekking op een ouder die gezag had |
        | D               | een derde                    |     2 | de ontkenning heeft geen betrekking op een ouder die gezag had |
        |              1D | ouder 1 en een derde         |     1 | de gezaghebbende ouder heeft ouderschap ontkend                |
        |              2D | ouder 2 en een derde         |     2 | de gezaghebbende ouder heeft ouderschap ontkend                |

    Abstract Scenario: er is uitspraak gezag voor <omschrijving gezagsuitspraak> en erkenning door ouder <ouder> is ontkend of vernietigd er is sprake van gezamenlijk gezag want de ontkenning heeft geen betrekking op de gezaghebbende ouder
      Gegeven voor 'Kees' is een gerechtelijke uitspraak over het gezag gedaan met de volgende gegevens
        | indicatie gezag minderjarige (32.10) | ingangsdatum geldigheid (85.10) |
        | <indicatie gezag>                    | morgen - 10 jaar                |
      En zijn van ouder <ouder> de volgende gegevens gewijzigd
      ...
      Voorbeelden:
        | indicatie gezag | omschrijving gezagsuitspraak | ouder | gezaghebbende ouder |
        |              1D | ouder 1 en een derde         |     2 |           000000012 |
        |              2D | ouder 2 en een derde         |     1 |           000000024 |
