    ...
    Scenario: <omschrijving>
      ...
      * is erkend door 'erkenner' als ouder <categorie erkenner> met erkenning na geboorteaangifte op 15-3-2022
      ...
      Voorbeelden:
        ...
        |                1 |                  2 | is overleden         | is bevoegd           | geboortemoeder is overleden en andere ouder is wel bevoegd         | Tijdelijk geen gezag omdat de ouder overleden is.         | 54v1o2 |
        |                1 |                  2 | staat onder curatele | is bevoegd           | geboortemoeder staat onder curatele en andere ouder is wel bevoegd | Tijdelijk geen gezag omdat de ouder onder curatele staat. | 54v1o2 |
        |                1 |                  2 | is minderjarig       | is bevoegd           | geboortemoeder is minderjarig en andere ouder is wel bevoegd       | Tijdelijk geen gezag omdat de ouder minderjarig is.       | 54v1o2 |
        ...
        |                2 |                  1 | is overleden         | is bevoegd           | geboortemoeder is overleden en andere ouder is wel bevoegd         | Tijdelijk geen gezag omdat de ouder overleden is.         | 54v2o1 |
        |                2 |                  1 | staat onder curatele | is bevoegd           | geboortemoeder staat onder curatele en andere ouder is wel bevoegd | Tijdelijk geen gezag omdat de ouder onder curatele staat. | 54v2o1 |
        |                2 |                  1 | is overleden         | is bevoegd           | geboortemoeder is minderjarig en andere ouder is wel bevoegd       | Tijdelijk geen gezag omdat de ouder overleden is.         | 54v2o1 |
