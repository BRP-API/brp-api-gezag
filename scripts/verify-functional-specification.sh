...
npx cucumber-js -f json:./test-reports/cucumber-js/gezag-deprecated/specs-result.json \
...
npx cucumber-js -f json:./test-reports/cucumber-js/gezag/specs-result.json \
